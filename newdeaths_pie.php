...
while($row = mysqli_fetch_array($country)){
	...
	$query = mysqli_query($koneksi,"SELECT sum(new_deaths) AS new_deaths FROM penderita WHERE id_country='".$row['id_country']."'");
...
<head>
	<h1>ANGKA NEW DEATHS COVID-19</h1>
...
<body>
	...
	<script>
		var config = {
			...
			data: {
				datasets: [{
					label: 'Presentase New Deaths Covid-19',
