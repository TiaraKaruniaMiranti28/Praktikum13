...
while($row = mysqli_fetch_array($country)){
	...
	$query = mysqli_query($koneksi,"SELECT sum(total_deaths) AS total_deaths FROM penderita WHERE id_country='".$row['id_country']."'");
...
<head>
	<h1>ANGKA TOTAL DEATHS COVID-19</h1>
...
<body>
	...
	<script>
		var config = {
			...
			data: {
				datasets: [{
					label: 'Presentase Total Deaths Covid-19',
